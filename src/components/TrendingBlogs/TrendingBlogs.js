      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          <div className="text-center md:text-left mb-6 md:mb-0">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 text-emerald-600 mb-4">
          ...
          <Link
            href="/blogs"
            className="group hidden md:flex items-center gap-2 px-6 py-3 bg-emerald-600 text-white rounded-full font-semibold hover:bg-emerald-700 transition-all duration-300"
          >
            View All Articles
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-8">
            {[...Array(3)].map((_, index) => (
              ...
              >
                <div className="relative h-48 bg-emerald-100 animate-pulse"></div>
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {[...Array(3)].map((_, tagIndex) => (
                      <div
                        key={tagIndex}
                        className="h-6 w-16 bg-emerald-100 rounded-md animate-pulse"
                      ></div>
                    ))}
                  </div>
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="flex justify-between">
                      <div className="h-4 w-28 bg-emerald-100 rounded animate-pulse"></div>
